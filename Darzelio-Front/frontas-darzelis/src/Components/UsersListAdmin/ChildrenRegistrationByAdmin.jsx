...
export default class ChildrenRegistrationByAdmin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      birthdate: new Date(),
  ...
  render() {
    ...
    if (this.state.parentId > 0) {
            ...
            <form onSubmit={this.handleSubmit} className="form-row ">
              ...
              {this.state.secondParent ? (
                <div className="form-row">
                  ...
                  {this.state
                    .secondParentDeclaredResidenceSameAsLiving ? null : (
                    <div className="form-row">
                      <div className="form-group mb-3 col-6 mt-3">
                        <label
      ...
      return (
        <div>
          <p>Pirma užpildykite tėvo/globėjo duomenis</p>
        </div>
      );
    }
  }
