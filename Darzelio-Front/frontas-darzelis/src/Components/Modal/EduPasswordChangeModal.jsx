...
const EduPasswordChangeModal = ({modalState, onClick}) => {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <a href={`/bean-app/admin/edu/duomenys/redaguoti/slaptazodi`} type="button" className="btn">Keisti slaptažodį</a>
                    </div>
                </div>
            </div>
        </div>
...
export default EduPasswordChangeModal